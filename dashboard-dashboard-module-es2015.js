...
const routes = [
    ...
    {
        path: "empdetails/:eid", component: _empdetails_empdetails_component__WEBPACK_IMPORTED_MODULE_5__["EmpdetailsComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
...
/* harmony import */ var _empdetails_empdetails_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../empdetails/empdetails.component */ "./src/app/empdetails/empdetails.component.ts");
...
DashboardModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _empdetails_empdetails_component__WEBPACK_IMPORTED_MODULE_7__["EmpdetailsComponent"],
...
let EmpdetailsComponent = class EmpdetailsComponent {
    ...
    GetDtaFromUrl() {
        this.route.paramMap
            ...
            this.GetDtaWholeBackend(para.get("eid"));
        });
    }
    //getting whole data from id ==>> GetdatabyID
    GetDtaWholeBackend(employeeid) {
        this.service.grtEmpBYId(employeeid)
            .subscribe((response) => {
...
let UpdateEmployeeComponent = class UpdateEmployeeComponent {
    ...
    onupdate() {
        ...
        this.service.updateEmployee(this.parentdata)
            .subscribe((response) => {
            // console.log(response)
            this.issubmitDissabled = false; //to display updated succusfully and btton become disble
